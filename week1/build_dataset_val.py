...
ann_file = r"coco\annotations\instances_val2017.json"
...
for image_id, label in image_id_to_label.items():
    ...
    file_path = os.path.join("val2017", file_name)
...
csv_path = r"output\coco_person_car_val.csv"
